    ...
    <div class="container">
      <section class="row">
        ...
        <div class="col-sm-3 col-md-3">
          ...
          <form class="" action="botonesAdministrativo.php" method="post">
    ...
    <section class="color1 row">
      <div class="col-xs-9 col-sm-5 col-md-4">
        <div class="botonesA col-md-11">
          ...
          <form class="" action="botonesAdministrativo.php" method="post">
            ...
            <input type="submit" class="botones btn btn-primary" name="crear" value="Crear Curso">
          </form>
          <br>
      ...
      <div class="atras col-xs-12 col-sm-7 col-md-8">
        ...
        <form class="" action="crear.php" method="post">
         ...
         <input type="submit" class="trans btn btn-success" name="enviar" value="Crear"><br><br>
        </form>
        <?php
